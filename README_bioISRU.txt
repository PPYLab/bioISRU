...
Requires download and installation of Phasepy Python package (https://pypi.org/project/phasepy/)
...
To determine process specifications for varying inputs, the Sample_data_Peralta-Yayha.csv file can be edited to test for desired combinations of biomass productivity, digester yield, fermenter yeild, and material density
